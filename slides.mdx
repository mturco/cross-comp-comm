...
TODO:
- pattern 4 example
- work in testing difficulty somewhere?
- are the patterns interesting enough? are there enough of them?
- outro
-->
...
1. Using context to provide common data at the application level
