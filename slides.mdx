...
<Notes>
  ...
  between components which we'll revisit later
</Notes>
...
<Notes>
  ...
  <hr />
  TODO: Separation of concerns (prop-drilled components take
  props they themselves may not care about)
</Notes>
...
<Notes>
  ...
  <hr />
  TODO: So here's an example of context cleaning up the API of a
...
<Notes>
  ...
  HTML form but also does some basic state management for us
  <hr />
